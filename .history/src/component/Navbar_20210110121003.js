...
export default function ButtonAppBar() {
  ...
  return (
    <div className={classes.root}>
     ...
     <Link to={!user  && "/sign_in"} style={{textDecoration:'none'}}><Button variant="contained" disableElevation className={classes.menuButton} color="secondary">Sign In</Button></Link>
