...
console.log("userdata",userData)
  return (
    <div className={classes.root}>
     ...
     { userData.isStudent === true &&(<Link> <Button variant="outlined" disableElevation className={classes.menuButton} color="secondary">{userData.firstName}</Button></Link> )}
    
      {userData.isStudent === false && <Link to="/companyDashboard"><Button variant="outlined" disableElevation className={classes.menuButton} color="secondary">company</Button></Link>}
