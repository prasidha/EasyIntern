...
function Search(props) {
    ...
    return (
        <Box className={classes.wrapper} mt={-5} mb={4} p={2}>
           <Input name="search" value={props.search} onChange={(e)=>props.setSearch(e.target.value)} color="secondary" disableUnderline placeholder="  search here..." className={classes.input}/>
