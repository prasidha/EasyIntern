...
console.log("userdata",userData)
  return (
    <div className={classes.root}>
     ...
     { userData.isStudent === true && <Button variant="contained" disableElevation className={classes.menuButton} color="secondary">student</Button> }
    
      {userData.isStudent === false && <Button variant="contained" disableElevation className={classes.menuButton} color="secondary">company</Button>}
