    ...
    return (
        <Dialog open={!!Object.keys(props.data).length} fullWidth>
            ...
            <Box mt={-1}>
                ...
                <Box display="flex" mb={1} justifyContent='space-evenly'>
                    <Typography variant="h5">Company Url:</Typography>
                    <Typography variant="h5"><a href={props.data.url}>{props.data.url}</a></Typography>
                </Box>

                <Box display="flex"  mb={1}>
                   <Typography variant="h5">Apply Link:</Typography>
                   <Typography variant="h5"><a href={props.data.link}>{props.data.link}</a></Typography>
                </Box>
