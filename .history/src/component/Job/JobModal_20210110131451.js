...
function JobModal(props) {
    const skills=["JavaScript","Node","Python","MongoDB","Vue","firebase"];
       ...
       <Dialog open={props.modal}fullWidth>
            ...
            <DialogContent>
                <Grid container spacing={2}>
                   ...
                   {internDetails.title ,internDetails.description,internDetails.url,internDetails.link}
