...
export default function ButtonAppBar() {
  ...
  return (
    <div className={classes.root}>
     ...
     <Link to={!currentUser  && "/sign_in"} style={{textDecoration:'none'}}><Button variant="contained" disableElevation className={classes.menuButton} color="secondary" onClick={handleLogout}>{currentUser ? "Sign out" : "Sign in"}</Button></Link>
