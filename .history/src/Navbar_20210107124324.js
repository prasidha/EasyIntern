...
className={classes.Menu}
>
 <Link to="" style={{textDecoration:'none'}}> <MenuItem onClick={handleClose}>Applicants</MenuItem> </Link>
 <Link to="/postintern" style={{textDecoration:'none'}}> <MenuItem onClick={handleClose}>Post an Intern</MenuItem>  </Link>
  <MenuItem onClick={handleClose}><Button onClick={onLogOut}>Logout</Button></MenuItem>
</Menu>
