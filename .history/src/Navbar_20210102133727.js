...
{user userData.isStudent === false &&  <Link to="/companydashboard" style={{textDecoration:'none'}}> <Button color="primary" variant="contained" className={classes.menuButton}>{userData.companyName}<AccountCircleIcon/></Button></Link>}
        </Toolbar>
      </AppBar>
    </div>
  );
