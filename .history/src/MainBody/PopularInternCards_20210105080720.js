...
export default function RecipeReviewCard({dataa}) {
  ...
  console.log(dataa.id,"dataaaaaaa.............................")
  const onApplyPost = () => {
    db.collection("notification").doc(currentUser.uid).set({
             post:'added',   
  ...
  { userData?.isStudent === true?  <Button color="primary" variant="contained" style={{width:'100%'}} onClick={onApplyPost}>{ applyPosts ? "applied" :'apply'} </Button> :"" }
