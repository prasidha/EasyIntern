  ...
  return (
    <Card className={classes.root}>
      ...
      <CardContent>
       ...
       category :  <Typography variant="h5" display="inline" color='secondary'>
       {dataa.internPost.category}
        </Typography>
        </Typography>
       
        <Typography variant="h5" color='primary' display="initial" gutterBottom>
       Deadline : {dataa.internPost.category}
        </Typography>
      </CardContent>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        ...
        <Typography paragraph>
         {dataa.internPost.internTitle}
          ...
          <Typography paragraph>
           {dataa.internPost.companyWebsite} 
          </Typography>
