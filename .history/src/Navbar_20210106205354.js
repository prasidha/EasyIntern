...
>
  <MenuItem onClick={()=>{setOpen(flase)}}>Applicants</MenuItem>
  <MenuItem onClick={()=>{setOpen(flase)}}>Post an Intern</MenuItem>
  <MenuItem onClick={()=>{setOpen(flase)}}>Logout</MenuItem>
</Menu>
        </Toolbar>
      </AppBar>
    </div>
