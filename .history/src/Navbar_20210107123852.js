...
{ userData.isStudent === false && <Button color="primary" variant="contained"  onClick={()=>setAnchorE2(event.currentTarget)} className={classes.menuButton}>{userData.companyName} <AccountCircleIcon/></Button>}
<Menu
    anchorE2={anchorE2}
