...
export default () => {
 ...
 <Link to="company" style={{textDecoration:'none'}}> <Button  disableElevation variant="outlined" disabled={userData} style={{fontSize :'20px',padding:"15px"}}>
 ...
 Register as a Student <SchoolIcon/>
  ...
  <JobViewModal d={viewModal} close={()=>setViewModal({})}/>
