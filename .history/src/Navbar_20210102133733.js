...
{( userData.isStudent === false) ?   <Link to="/postintern" style={{textDecoration:'none'}}> <Button color="color" variant="contained" className={classes.menuButton}>Post</Button></Link>:'' }
  ...
  { userData.isStudent === true  && <Link to="/favourite" style={{textDecoration:'none'}}> <Button color="primary" variant="contained" className={classes.menuButton}>favorite</Button></Link>}
   { userData.isStudent === true  && <Link to="/studentdashboard" style={{textDecoration:'none'}}> <Button color="primary" variant="contained" className={classes.menuButton}><AccountCircleIcon/> {userData.firstName}</Button></Link>}
{userData && userData.isStudent === false &&  <Link to="/companydashboard" style={{textDecoration:'none'}}> <Button color="primary" variant="contained" className={classes.menuButton}>{userData.companyName}<AccountCircleIcon/></Button></Link>}
        </Toolbar>
      </AppBar>
    </div>
  );
