...
export default function ButtonAppBar() {
  ...
  const {currentUser,userData,setUserData,logOut,setIs}=useAuth();
...
>
 <Link to=""> <MenuItem onClose={()=>{setOpen(false)}}>Applicants</MenuItem> </Link>
 <Link to="/postintern"> <MenuItem onClose={()=>{setOpen(false)}}>Post an Intern</MenuItem>  </Link>
 <Link onClick={onHandleLogout}> <MenuItem onClose={()=>{setOpen(false)}}>Logout</MenuItem> </Link>
</Menu>
        </Toolbar>
      </AppBar>
    </div>
