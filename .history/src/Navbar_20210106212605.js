...
{userData.isStudent === false &&  <Link to="/companydashboard" style={{textDecoration:'none'}}> <Button color="primary" variant="contained" className={classes.menuButton}><AccountCircleIcon/></Button></Link>}

<Button aria-controls="simple-menu" aria-haspopup="true" onClick={(e)=>setAnchorE2(e.currentTarget)}>
 {userData.companyName}
</Button>
<Menu

>
  <MenuItem onClick={()=>{setAnchorE2(false)}}>Applicants</MenuItem>
  <MenuItem onClick={()=>{setAnchorE2(false)}}>Post an Intern</MenuItem>
  <MenuItem onClick={()=>{setAnchorE2(false)}}>Logout</MenuItem>
</Menu>
        </Toolbar>
      </AppBar>
    </div>
